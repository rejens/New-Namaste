...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                        ...
                        <li>
                            <a class="smooth-menu" href="#menu">Menu</a>
                        </li>
                        <li>
                            <a class="smooth-menu" href="#offer">Offer</a>
                        </li>
                        <li>
                            <a class="smooth-menu" href="#chef">Chef</a>
                        </li>
                        <li>
                            <a class="smooth-menu" href="#review">Rreview</a>
                        </li>
                        <li>
    ...
    <!-- Start Features Area
    ============================================= -->
    <div id="features" class="features-area default-padding">
        <div class="container">
            <div class="row">
    ...
    <!-- Start Food Menu
    ============================================= -->
    <div id="menu" class="food-menu-area inc-isotop default-padding">
        <div class="container">
            <div class="row">
    ...
    <!-- Start Chef Area 
    ============================================= -->
    <div id="chef" class="chef-area default-padding bottom-less">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="site-heading text-center">
    ...
    <!-- Start Testimonials 
    ============================================= -->
    <div id="review" class="testimonials-area bg-gray carousel-shadow default-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="site-heading text-center">
